  ...
  describe 'Parsers' do
	...
	@parser = Opstat::Parsers::Network.new
      ...
      it 'returns report with all parsed params when input data are correct' do
        ...
        time = Time.now
        result_expected = [{:tags => {:OPSTAT_TAG_interface=>"eth0"}, :values => {:bytes_receive=>9358089715, :packets_receive=>14775397, :errors_receive=>0, :drop_receive=>0, :fifo_receive=>0, :frame_receive=>0, :compressed_receive=>0, :multicast_receive=>0, :bytes_transmit=>6464020954, :packets_transmit=>9992120, :errors_transmit=>0, :drop_transmit=>0, :fifo_transmit=>0, :frame_transmit=>0, :compressed_transmit=>0, :multicast_transmit=>0}, :time => time}, {:time => time, :tags => {:OPSTAT_TAG_interface=>"docker0"}, :values => {:bytes_receive=>18218158, :packets_receive=>109291, :errors_receive=>0, :drop_receive=>0, :fifo_receive=>0, :frame_receive=>0, :compressed_receive=>0, :multicast_receive=>0, :bytes_transmit=>367125883, :packets_transmit=>110865, :errors_transmit=>0, :drop_transmit=>0, :fifo_transmit=>0, :frame_transmit=>0, :compressed_transmit=>0, :multicast_transmit=>0}}, {:time => time, :tags => {:OPSTAT_TAG_interface=>"lo"}, :values => {:bytes_receive=>4991778180, :packets_receive=>4308431, :errors_receive=>0, :drop_receive=>0, :fifo_receive=>0, :frame_receive=>0, :compressed_receive=>0, :multicast_receive=>0, :bytes_transmit=>4991778180, :packets_transmit=>4308431, :errors_transmit=>0, :drop_transmit=>0, :fifo_transmit=>0, :frame_transmit=>0, :compressed_transmit=>0, :multicast_transmit=>0}}]
